			...
			<div class="header">
				<div class="contact">
					...
					<form action="index.html">
						...
						<input type="text" name="Email Address" placeholder="Email Adress" onblur="this.value=!this.value?'Email Address':this.value;" onfocus="this.select()" onclick="this.value='';"></input>
